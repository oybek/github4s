...
class Repos[C, M[_]](implicit urls: GithubApiUrls,
  ...
  /**
    ...
    */
  def listOrgRepos(accessToken: Option[String] = None,
                   headers: Map[String, String] = Map(),
                   org: String,
                   `type`: Option[String] = None,
                   pagination: Option[Pagination] = Some(
                     httpClient.defaultPagination
  ...
  /**
    ...
    */
  def listUserRepos(accessToken: Option[String] = None,
                    headers: Map[String, String] = Map(),
                    user: String,
                    `type`: Option[String] = None,
                    pagination: Option[Pagination] = Some(
  ...
  ): M[GHResponse[NonEmptyList[Content]]] =
  ...
  /**
    ...
    */
  def listCommits(accessToken: Option[String] = None,
                  headers: Map[String, String] = Map(),
                  owner: String,
                  repo: String,
  ...
  def listBranches(
    ...
    httpClient.get[List[Branch]](
      ...
      headers,
      Map("protected" → onlyProtected.map(_.toString)).collect {
        case (key, Some(value)) ⇒ key → value
      }
    )
  ...
  def listContributors(
    ...
    httpClient.get[List[User]](
      accessToken,
      s"repos/$owner/$repo/contributors" + pagination
        .map(x => s"?page=${x.page}&per_page=${x.per_page}")
        .getOrElse(""),
      headers,
      Map("anon" → anon).collect {
        case (key, Some(value)) ⇒ key → value
      }
    )
  ...
  def listCollaborators(
    ...
    httpClient.get[List[User]](
      ...
      headers,
      Map("affiliation" -> affiliation).collect {
        case (key, Some(value)) => key -> value
      }
    )
  ...
  /**
    ...
    */
  def getStatus(accessToken: Option[String] = None,
                headers: Map[String, String] = Map(),
                owner: String,
                repo: String,
  ...
  /**
    ...
    */
  def listStatuses(accessToken: Option[String] = None,
                   headers: Map[String, String] = Map(),
                   owner: String,
                   repo: String,
  ...
  /**
    ...
    */
  def createStatus(accessToken: Option[String] = None,
                   headers: Map[String, String] = Map(),
                   owner: String,
                   repo: String,
                   sha: String,
    ...
    httpClient.post[Status](
      ...
      headers,
      dropNullPrint(
        NewStatusRequest(state, target_url, description, context).asJson
      )
    )
}
